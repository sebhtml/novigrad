...
fn test_reads_and_writes_of_same_operand_are_not_reordered() {
    ...
    verify_that_accesses_are_not_reordered::<GpuStreamScheduler<_>>(access, prior_access);
}
...
fn test_all_instructions_are_executed_with_out_of_order_execution() {
    verify_that_all_instructions_are_executed_with_out_of_order_execution::<GpuStreamScheduler<_>>(
    );
}

#[test]
fn test_all_instructions_are_executed_in_each_scheduler_execution() {
    verify_that_all_instructions_are_executed_in_each_scheduler_execution::<GpuStreamScheduler<_>>(
    );
}
